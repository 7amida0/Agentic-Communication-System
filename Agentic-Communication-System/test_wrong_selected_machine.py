...
async def main() -> None:
    ...
    fake_reasoning = (
        "Machine M01 was selected because it is the best machine for the order."
    )
    ...
    request = VerificationRequest(
        ...
        fallback_explanation=(
            "Machine M02 was selected by the deterministic decision rules."
        ),
    )
