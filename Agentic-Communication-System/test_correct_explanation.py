...
async def main() -> None:
    ...
    correct_reasoning = (
        "Machine M02 was selected because it has the required milling "
        "capability, a queue length of 1, a processing time of 60 minutes, "
        "a maintenance condition of 82%, and a quality risk score of 0.3."
    )
    ...
    request = VerificationRequest(
        ...
        fallback_explanation=(
            "Machine M02 was selected because it passed all required checks."
        ),
    )
    ...
    if response.status.lower() == "passed":
        print("TEST PASSED")
    else:
        print("TEST FAILED")
